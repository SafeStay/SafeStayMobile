...
export const FirebaseHotels = () => {
  ...
  const url = `https://api.geoapify.com/v2/places?categories=accommodation.hotel&filter=rect:-0.150204,51.48156,-0.04797358020363348,51.66288544904521&limit=500&apiKey=${process.env.EXPO_PUBLIC_GEOAPIKEY}`;
...
export const FirebaseDeleteHotelData = () => {
  const deleteHotelData = async () => {
    try {
      ...
      console.log("All documents in hotels11 collection successfully deleted.");
    } catch (error) {
